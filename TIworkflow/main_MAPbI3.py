...
if __name__ == '__main__':
    ...
    MLP_model_dct = {
                ...
                "cpu_single"   : File(str(Path.cwd() / "data" / "MACE_MA_cpu_float32.model")),
                "cpu_double"   : File(str(Path.cwd() / "data" / "MACE_MA_cpu_float64.model")),
                "cuda_single"  : None, 
                "cuda_double"  : None,
                "config"       : None, 
                "undeployed"   : None,
    ...
    for phase in phase_lst:
        init_struc[phase] = File(str(Path.cwd() / "data" / str("atoms_MA_"+phase+".xyz")))
    ...
    nsteps_dct = {
        ...
        "NVT_MD"           : (5, 0, 400000),
        "NVE_MD"           : (5, 0, 400000),
        "lmd_low"          : (5, 500, 400000),
        "lmd_REX"          : (5, 500, 2000, 200),
        "lmd_high"         : (5, 500, 400000),
        "NPT_MD_sup"       : (32, 0, 25000),
        "REX_NVT_sup"      : (10, 0, 500, 200),
        "NVE_MD_sup"       : (10, 0, 100000),
        "lmd_low_sup"      : (10, 100, 100000),
        "lmd_REX_sup"      : (10, 100, 500, 200),
        "lmd_high_sup"     : (10, 100, 100000),
    }
    kwargs = {
        ...
        "MLP_int"          : 1.0,                #fraction of MLP at the end of the low temperature TI step and begin of the high temperature TI step
        ...
        "bias_int"         : 1.0,                #fraction of bias at the end of the low temperature TI step and begin of the high temperature TI step
        ...
        "freq_max"         : 125.0,              #in THz, maximum frequency plotted in the frequency spectra of hessian and vacf
        ...
        "vol_ind_lst"      : [10,19,27],         #The indices which are used to determine at which temperature we determine the average volume to perform the NVT simulations 
        "vol_ind_lst_sup"  : [10,19,27],         #same but for supercell simulations, leave the list empty if you do not want to perform any supercell simulations
    }
