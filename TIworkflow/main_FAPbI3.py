...
if __name__ == '__main__':
    ...
    MLP_model_dct = {
                ...
                "cpu_single"   : File(str(Path.cwd() / "data" / "MACE_FA_cpu_float32.model")),
                "cpu_double"   : File(str(Path.cwd() / "data" / "MACE_FA_cpu_float64.model")),
                "cuda_single"  : None, 
                "cuda_double"  : None,
                "config"       : None, 
                "undeployed"   : None,
    ...
    for phase in phase_lst:
        init_struc[phase] = File(str(Path.cwd() / "data" / str("atoms_FA_"+phase+".xyz")))
